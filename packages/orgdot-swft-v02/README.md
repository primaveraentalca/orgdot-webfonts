# orgdot-swft-v02
The CSS and web font files to easily self-host Orgdot SWF!T_v02.
...
## Install
First, install like any other package<br />`npm install --save orgdot-swft-v02`

## Usage
Require the package in your entry file.<br />`require('orgdot-swft-v02')`

Then, use the font in your styles<br />`font-family: 'SWF!T_v02';`
