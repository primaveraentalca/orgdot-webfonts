...
## Install
First, install like any other package<br />`npm install --save orgdot-kharon4a-bold`

## Usage
Require the package in your entry file.<br />`require('orgdot-kharon4a-bold')`

Then, use the font in your styles<br />`font-family: 'Kharon4a Bold';`
