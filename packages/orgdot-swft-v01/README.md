...
## Install
First, install like any other package<br />`npm install --save orgdot-swft-v01`

## Usage
Require the package in your entry file.<br />`require('orgdot-swft-v01')`

Then, use the font in your styles<br />`font-family: 'SWF!T_v01';`
