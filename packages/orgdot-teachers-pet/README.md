# orgdot-teachers-pet
The CSS and web font files to easily self-host Orgdot Teachers Pet.
...
## Install
First, install like any other package<br />`npm install --save orgdot-teachers-pet`

## Usage
Require the package in your entry file.<br />`require('orgdot-teachers-pet')`

Then, use the font in your styles<br />`font-family: 'Teachers Pet';`
