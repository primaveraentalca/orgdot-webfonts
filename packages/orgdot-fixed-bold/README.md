# orgdot-fixed-bold
The CSS and web font files to easily self-host Orgdot fixed_bold.
...
## Install
First, install like any other package<br />`npm install --save orgdot-fixed-bold`

## Usage
Require the package in your entry file.<br />`require('orgdot-fixed-bold')`

Then, use the font in your styles<br />`font-family: 'fixed_bold';`
