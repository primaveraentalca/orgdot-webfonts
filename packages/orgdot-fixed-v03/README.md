# orgdot-fixed-v03
The CSS and web font files to easily self-host Orgdot fixed_v03.
...
## Install
First, install like any other package<br />`npm install --save orgdot-fixed-v03`

## Usage
Require the package in your entry file.<br />`require('orgdot-fixed-v03')`

Then, use the font in your styles<br />`font-family: 'fixed_v03';`
