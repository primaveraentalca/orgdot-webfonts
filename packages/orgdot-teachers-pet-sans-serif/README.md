# orgdot-teachers-pet-sans-serif
The CSS and web font files to easily self-host Orgdot Teachers Pet Sans Serif.
...
## Install
First, install like any other package<br />`npm install --save orgdot-teachers-pet-sans-serif`

## Usage
Require the package in your entry file.<br />`require('orgdot-teachers-pet-sans-serif')`

Then, use the font in your styles<br />`font-family: 'Teachers Pet Sans Serif';`
