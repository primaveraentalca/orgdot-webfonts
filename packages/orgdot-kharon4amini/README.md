# orgdot-kharon4amini
The CSS and web font files to easily self-host Orgdot kharon4a_mini.
...
## Install
First, install like any other package<br />`npm install --save orgdot-kharon4amini`

## Usage
Require the package in your entry file.<br />`require('orgdot-kharon4amini')`

Then, use the font in your styles<br />`font-family: 'kharon4a_mini';`
