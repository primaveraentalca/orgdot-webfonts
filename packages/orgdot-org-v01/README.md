# orgdot-org-v01
The CSS and web font files to easily self-host Orgdot Org_v01.
...
## Install
First, install like any other package<br />`npm install --save orgdot-org-v01`

## Usage
Require the package in your entry file.<br />`require('orgdot-org-v01')`

Then, use the font in your styles<br />`font-family: 'Org_v01';`
